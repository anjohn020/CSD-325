...
WIDTH = 79
HEIGHT = 22
LAKE_WIDTH = range(35, 45)  # Centered horizontally
LAKE_HEIGHT = range(9, 14)  # Centered vertically
    ...
    while True:  # Main program loop.
        ...
        for x in range(forest['width']):
            for y in range(forest['height']):
                ...
                if forest[(x, y)] == WATER:
                    # Water never changes - it's permanent
                    ...
                    for ix in range(-1, 2):
                        for iy in range(-1, 2):
                            # Fire spreads to neighboring trees (but not through water):
